    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px" }}>
          ...
          {tab === "lore" && (
            <div>
              <Section title="Мир Cursed Legacy">
                <div style={{ color: "#8b7aa8", fontSize: 12, lineHeight: 1.8, marginBottom: 12 }}>
                  Проклятые духи — порождения человеческих страхов. Они невидимы для обычных людей, но смертельно опасны. Маги проклятий — единственные, кто может с ними сражаться.
                </div>
                <div style={{ color: "#8b7aa8", fontSize: 12, lineHeight: 1.8, marginBottom: 12 }}>
              ...
              <Section title="Проклятая энергия (CE)">
                <div style={{ color: "#8b7aa8", fontSize: 12, lineHeight: 1.8 }}>
                  CE — это отрицательная эмоциональная энергия, преобразованная и направленная магом. Обратная техника использует позитивную CE для исцеления — редкое и сложное умение.
                </div>
              </Section>
              <Section title="Техники">
                <div style={{ color: "#8b7aa8", fontSize: 12, lineHeight: 1.8 }}>
                  Врождённые техники даются от рождения. Но упорной тренировкой маг способен освоить чужие приёмы — пусть и не с той же эффективностью, что их природный носитель.
                </div>
              </Section>
            </div>
          )}
